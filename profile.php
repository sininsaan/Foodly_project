...
<aside class="sidebar">
    ...
    <div class="sidebar-footer">
        <a href="profile.php" style="text-decoration:none;">
            <div class="user-pill" style="cursor:default;transition:var(--transition);" onmouseover="this.style.background='rgba(255,255,255,0.12)'" onmouseout="this.style.background='rgba(255,255,255,0.06)'">
...
<main class="main-content">
    ...
    <div class="profile-wrapper"><div class="profile-card"> 
